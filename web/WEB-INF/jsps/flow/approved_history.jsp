...
<div id="MainArea">
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <c:if test="${empty approveList}">没有审批信息</c:if>
        <c:forEach items="${approveList}" var="approve">
            <!--显示数据列表-->
            <tr class="TableDetail1 template">
                <td>${approve.approver.loginName}&nbsp;</td>
                <td><fmt:formatDate value="${approve.approveDate}" pattern="yyyy-MM-dd HH:mm:ss"/>&nbsp;</td>
                <td>${approve.isPassed}&nbsp;</td>
                <td>${approve.suggestion}&nbsp;</td>
            </tr>
        </c:forEach>
