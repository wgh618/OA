...
<!--显示表单内容-->
<div id="MainArea">
    <form action="${pageContext.request.contextPath}/role/edit" method="post" onsubmit="return check();">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><input type="text" name="name" id="name" value="${role.name}" class="InputStyle" /> *
                            (角色名要唯一)</td>
                    </tr>
                    <tr>
                        <td>岗位说明</td>
