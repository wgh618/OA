...
<div id="MainArea">
    ...
    <center>
        <div class="ItemBlock_Title1" style="width: 98%;">
            ...
            <font class="MenuPoint"> &gt; </font>
            ${forum.name}
            <span style="margin-left:30px;"><a href="${pageContext.request.contextPath}/topic/addUI/${forum.id}">
				<img align="absmiddle"
                     src="${pageContext.request.contextPath}/style/blue/images/button/publishNewTopic.png"/></a>
			</span>
        </div>
                ...
                <c:forEach items="${topicList}" var="topic">
                    <tr height="35" id="d0" class="template">
                        ...
                        <td class="ForumTopicPageDataLine" align="center"><img
                                src="${pageContext.request.contextPath}/style/images/topicType_${topic.type}.gif"/></td>
                        <td class="Topic"><a class="Default"
                                             href="${pageContext.request.contextPath}/topic/show/${topic.id}
												 ">${topic.title}</a></td>
                        <td class="ForumTopicPageDataLine">
                            <ul class="ForumPageTopicUl">
                                <li class="Author">${topic.author.loginName}</li>
                                <li class="CreateTime"><fmt:formatDate value="${topic.postTime}"
                        ...
                        <td class="ForumTopicPageDataLine">
                            <ul class="ForumPageTopicUl">
                                ...
                                <li class="CreateTime"><fmt:formatDate value="${topic.lastReply.postTime}"
                                                                       pattern="yyyy-MM-dd  HH:mm:ss"/></li>
                            </ul>
                        </td>
                        <td></td>
