						...
						<td align="center">
							<ul class="TopicFunc">
								...
								<li class="TopicFuncLi">
									...
									<a class="detail" href="${pageContext.request.contextPath}/topic/delete/${topic.id}" onClick="return confirm('确定要删除本帖吗？')"><img border="0"
						...
						<tr>
							...
							<td align="center">
								<ul class="TopicFunc">
									...
									<li class="TopicFuncLi">
										<%--<a class="detail" href="${pageContext.request.contextPath}/BBS_Topic/saveUI.html"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />编辑</a>--%>
										<a class="detail" href="${pageContext.request.contextPath}/reply/delete
										/${reply.id}"
										   onClick="return confirm('确定要删除本回复吗？')"><img
												border="0" src="${pageContext.request.contextPath}/style/images/delete.gif" />删除</a>
									</li>
									<!-- 文章表情与标题 -->
									<li class="TopicSubject">
