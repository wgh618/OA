...
<!--显示表单内容-->
<div id="MainArea">
<form action="${pageContext.request.contextPath}/reply/add/${topic.id}" style="margin: 0; padding: 0;" method="post">
	<div id="PageHead"></div>
	<center>
		...
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				<tr>
					<td class="InputAreaBg" width="7%" height="30"><div class="InputTitle">帖子主题</div></td>
