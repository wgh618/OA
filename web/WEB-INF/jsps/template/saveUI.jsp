...
<!--显示表单内容-->
<div id=MainArea>
    <form action="${pageContext.request.contextPath}/template/add" method="post" enctype="multipart/form-data">
        ...
        <div id="InputDetailBar">
            <input type="image" onclick="return check();" src="${pageContext.request.contextPath}/style/images/save.png"/>
