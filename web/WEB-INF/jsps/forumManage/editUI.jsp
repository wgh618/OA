...
<!--显示表单内容-->
<div id="MainArea">
    <form action="${pageContext.request.contextPath}/forum/edit" onsubmit="return check();" method="post">
        <input type="hidden" name="id" value="${forum.id}">
        <input type="hidden" name="position" value="${forum.position}">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><input id="name" type="text" name="name" class="InputStyle" value="${forum.name}"/> *</td>
                    </tr>
                    <tr>
                        <td>版块说明</td>
